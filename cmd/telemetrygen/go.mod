module github.com/jacktomcat/opentelemetry-collector-contrib/cmd/telemetrygen
...
// See https://github.com/jacktomcat/opentelemetry-collector-contrib/issues/27855.
