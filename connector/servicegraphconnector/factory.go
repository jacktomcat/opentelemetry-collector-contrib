...
import (
	...
	"github.com/jacktomcat/opentelemetry-collector-contrib/connector/servicegraphconnector/internal/metadata"
)
...
func init() {
	virtualNodeFeatureGate = featuregate.GlobalRegistry().MustRegister(
		...
		featuregate.WithRegisterReferenceURL("https://github.com/jacktomcat/opentelemetry-collector-contrib/issues/17196"),
	)
	...
	legacyMetricNamesFeatureGate = featuregate.GlobalRegistry().MustRegister(
		...
		featuregate.WithRegisterReferenceURL("https://github.com/jacktomcat/opentelemetry-collector-contrib/issues/18743,https://github.com/jacktomcat/opentelemetry-collector-contrib/issues/16578"),
	)
	legacyLatencyUnitMsFeatureGate = featuregate.GlobalRegistry().MustRegister(
		...
		featuregate.WithRegisterReferenceURL("https://github.com/jacktomcat/opentelemetry-collector-contrib/issues/27488"),
	)
}
