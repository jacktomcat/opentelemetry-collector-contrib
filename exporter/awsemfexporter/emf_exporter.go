...
import (
	...
	"github.com/jacktomcat/opentelemetry-collector-contrib/exporter/awsemfexporter/internal/metadata"
...
func newEmfExporter(config *Config, set exporter.CreateSettings) (*emfExporter, error) {
	...
	config.logger.Warn("the default value for DimensionRollupOption will be changing to NoDimensionRollup" +
		"in a future release. See https://github.com/jacktomcat/opentelemetry-collector-contrib/issues/23997 for more" +
		"information")
