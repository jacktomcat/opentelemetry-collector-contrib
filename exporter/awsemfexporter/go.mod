module github.com/jacktomcat/opentelemetry-collector-contrib/exporter/awsemfexporter
...
require (
	...
	github.com/jacktomcat/opentelemetry-collector-contrib/internal/aws/cwlogs v0.98.0
