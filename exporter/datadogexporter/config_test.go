...
func TestUnmarshal(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			err: "\"metrics::send_monotonic_counter\" was removed in favor of \"metrics::sums::cumulative_monotonic_mode\". See https://github.com/jacktomcat/opentelemetry-collector-contrib/issues/8489",
		},
		{
			...
			err: "\"tags\" was removed in favor of \"host_metadata::tags\". See https://github.com/jacktomcat/opentelemetry-collector-contrib/issues/9099",
		},
		{
			...
			err: "\"send_metadata\" was removed in favor of \"host_metadata::enabled\". See https://github.com/jacktomcat/opentelemetry-collector-contrib/issues/9099",
		},
		{
			...
			err: "\"use_resource_metadata\" was removed in favor of \"host_metadata::hostname_source\". See https://github.com/jacktomcat/opentelemetry-collector-contrib/issues/9099",
		},
		{
			...
			err: "\"metrics::report_quantiles\" was removed in favor of \"metrics::summaries::mode\". See https://github.com/jacktomcat/opentelemetry-collector-contrib/issues/8845",
		},
		{
			...
			err: "\"metrics::instrumentation_library_metadata_as_tags\" was removed in favor of \"metrics::instrumentation_scope_as_tags\". See https://github.com/jacktomcat/opentelemetry-collector-contrib/issues/11135",
		},
		{
