...
package ec2 // import "github.com/jacktomcat/opentelemetry-collector-contrib/exporter/datadogexporter/internal/hostmetadata/internal/ec2"
...
import (
	...
	ec2provider "github.com/jacktomcat/opentelemetry-collector-contrib/internal/metadataproviders/aws/ec2"
)
...
func (p *Provider) instanceTags(ctx context.Context) (*ec2.DescribeTagsOutput, error) {
	...
	// Similar to:
	// - https://github.com/jacktomcat/opentelemetry-collector-contrib/blob/39dbc1ac8/processor/resourcedetectionprocessor/internal/aws/ec2/ec2.go#L118-L151
