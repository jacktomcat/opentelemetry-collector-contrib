module github.com/jacktomcat/opentelemetry-collector-contrib/exporter/lokiexporter
...
require (
	...
	github.com/jacktomcat/opentelemetry-collector-contrib/pkg/translator/loki v0.98.0
