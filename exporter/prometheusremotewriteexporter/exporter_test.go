...
func Test_PushMetrics(t *testing.T) {
	...
	for _, useWAL := range []bool{true, false} {
		...
		t.Run(name, func(t *testing.T) {
			if useWAL {
				t.Skip("Flaky test, see https://github.com/jacktomcat/opentelemetry-collector-contrib/issues/9124")
			}
...
func TestWALOnExporterRoundTrip(t *testing.T) {
	t.Skip("skipping test, see https://github.com/jacktomcat/opentelemetry-collector-contrib/issues/10142")
	if testing.Short() {
