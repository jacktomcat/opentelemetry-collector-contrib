...
package matcher // import "github.com/jacktomcat/opentelemetry-collector-contrib/pkg/stanza/fileconsumer/matcher"
...
import (
	...
	"github.com/jacktomcat/opentelemetry-collector-contrib/pkg/stanza/fileconsumer/matcher/internal/filter"
	"github.com/jacktomcat/opentelemetry-collector-contrib/pkg/stanza/fileconsumer/matcher/internal/finder"
)
...
var mtimeSortTypeFeatureGate = featuregate.GlobalRegistry().MustRegister(
	...
	featuregate.WithRegisterReferenceURL("https://github.com/jacktomcat/opentelemetry-collector-contrib/issues/27812"),
)
