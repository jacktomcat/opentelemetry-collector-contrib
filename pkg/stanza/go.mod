module github.com/jacktomcat/opentelemetry-collector-contrib/pkg/stanza
...
replace github.com/jacktomcat/opentelemetry-collector-contrib/pkg/pdatatest => ../pdatatest
