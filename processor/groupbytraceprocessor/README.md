...
such as a tail-based sampler or a per-trace metrics processor. Note that [`tailsamplingprocessor`](https://github.com/jacktomcat/opentelemetry-collector-contrib/tree/main/processor/tailsamplingprocessor) 
