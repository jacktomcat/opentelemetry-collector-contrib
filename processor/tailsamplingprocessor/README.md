...
Before performing sampling, spans will be grouped by `trace_id`. Therefore, the tail sampling processor can be used directly without the need for the [`groupbytraceprocessor`](https://github.com/jacktomcat/opentelemetry-collector-contrib/tree/main/processor/groupbytraceprocessor).
