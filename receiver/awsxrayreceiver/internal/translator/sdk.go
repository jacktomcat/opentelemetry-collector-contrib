	...
	if seg.AWS != nil && seg.AWS.XRay != nil {
		...
		if xr.SDK != nil {
			...
			if seg.Cause != nil && len(seg.Cause.Exceptions) > 0 {
				// https://github.com/jacktomcat/opentelemetry-collector-contrib/blob/c615d2db351929b99e46f7b427f39c12afe15b54/exporter/awsxrayexporter/translator/cause.go#L150
