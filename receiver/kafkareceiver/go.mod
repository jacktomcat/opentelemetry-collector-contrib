module github.com/jacktomcat/opentelemetry-collector-contrib/receiver/kafkareceiver
...
require (
	...
	github.com/jacktomcat/opentelemetry-collector-contrib/pkg/translator/azure v0.98.0
