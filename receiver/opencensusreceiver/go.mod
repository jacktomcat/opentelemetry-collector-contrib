module github.com/jacktomcat/opentelemetry-collector-contrib/receiver/opencensusreceiver
...
require (
	...
	github.com/jacktomcat/opentelemetry-collector-contrib/pkg/translator/opencensus v0.98.0
