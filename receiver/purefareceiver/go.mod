module github.com/jacktomcat/opentelemetry-collector-contrib/receiver/purefareceiver
...
replace github.com/jacktomcat/opentelemetry-collector-contrib/receiver/prometheusreceiver => ../prometheusreceiver
