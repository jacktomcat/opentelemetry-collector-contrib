module github.com/jacktomcat/opentelemetry-collector-contrib/receiver/windowsperfcountersreceiver
...
require (
	...
	github.com/jacktomcat/opentelemetry-collector-contrib/pkg/winperfcounters v0.98.0
